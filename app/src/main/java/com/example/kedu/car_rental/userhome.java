    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(userhome.this, new DatePickerDialog.OnDateSetListener() {
        ...
        e5.setOnClickListener(new View.OnClickListener()  {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(userhome.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        e5.setText( selectedHour + ":" + selectedMinute);
                    }
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),updateprofileuser.class);
                startActivity(i);
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),viewreservation.class);
                startActivity(i);
            }
        });
